...
<body>
    <div class="container">
        <?php
            ...
            /*Esto es el bloque de código para poder modificar el anime*/
            $id_anime = $_GET["id_anime"];
            /*$sql = "SELECT * FROM animes WHERE id_anime = '$id_anime'";//El id de anime viene desde el otro lado
            $resultado = $_conexion -> query($sql);*/

            //PARA LOS SELECT TENEMOS EL PASO ADICIONAL
            #1. Prepare
        ...
        <form class="col-4" action="" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="titulo" value="<?php echo $anime["titulo"]?>">
            </div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="anno_estreno" value="<?php echo $anime["anno_estreno"]?>">
            </div>

            <div class="mb-3">
                <label class="form-label">Número de temporadas</label>
                <input class="form-control" type="text" name="num_temporadas" value="<?php echo $anime["num_temporadas"]?>">
            </div>
